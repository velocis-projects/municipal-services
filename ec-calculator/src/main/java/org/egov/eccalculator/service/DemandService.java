...
import org.egov.eccalculator.repository.CalculationRepository;
import org.egov.eccalculator.repository.DemandRepository;
import org.egov.eccalculator.repository.ServiceRequestRepository;
import org.egov.eccalculator.repository.builder.CalculationQueryBuilder;
import org.egov.eccalculator.utils.CalculationUtils;
import org.egov.eccalculator.utils.ECCalculatorConstants;
import org.egov.eccalculator.web.models.Calculation;
import org.egov.eccalculator.web.models.RequestInfoWrapper;
import org.egov.eccalculator.web.models.demand.Demand;
import org.egov.eccalculator.web.models.demand.DemandDetail;
import org.egov.eccalculator.web.models.demand.DemandResponse;
	...
	private List<Demand> createDemand(RequestInfo requestInfo, List<Calculation> calculations, Object mdmsData) {
		...
		for (Calculation calculation : calculations) {
			...
			demands.add(Demand.builder().consumerCode(consumerCode).demandDetails(demandDetails).payer(User.builder().uuid(userUuid).build())
					...
					.taxPeriodFrom(taxPeriods.get(ECCalculatorConstants.MDMS_STARTDATE))
					.taxPeriodTo(taxPeriods.get(ECCalculatorConstants.MDMS_ENDDATE))
