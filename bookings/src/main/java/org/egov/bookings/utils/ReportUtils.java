...
import org.egov.bookings.contract.ColumnDetail;
import org.egov.bookings.contract.ReportRequest;
import org.egov.bookings.contract.ReportResponse;
...
public class ReportUtils {
	...
	public MdmsCriteriaReq getRequestForServiceDefsSearch(StringBuilder uri, String tenantId, RequestInfo requestInfo) {
		...
		MasterDetail masterDetail = org.egov.mdms.model.MasterDetail.builder()
				.name(BookingsConstants.MDMS_SERVICETYPE_MASTER_NAME).build();
	...
	public List<String> getDepartment(RequestInfo requestInfo, List<String> departmentCodes, String tenantId) {
		...
		MdmsCriteriaReq mdmsCriteriaReq = bookingsUtils.prepareMdMsRequestForDept(deptUri, tenantId, departmentCodes, requestInfo);
		try {
			...
			departments = JsonPath.read(response, BookingsConstants.JSONPATH_DEPARTMENTS);
