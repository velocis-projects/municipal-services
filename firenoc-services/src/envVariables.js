const envVariables = {
  ...
  HOST_URL: process.env.HOST_URL || "https://egov-micro-qa.egovernments.org",
  ...
  EGOV_WORKFLOW_HOST: process.env.EGOV_WORKFLOW_HOST || "http://localhost:8088",
  // "https://egov-micro-qa.egovernments.org",
  ...
  EGOV_IDGEN_HOST:
    process.env.EGOV_IDGEN_HOST || "https://egov-micro-qa.egovernments.org",
  ...
  EGOV_MDMS_HOST:
    process.env.EGOV_MDMS_HOST || "https://egov-micro-qa.egovernments.org",
  ...
  EGOV_PROPERTY_HOST:
    process.env.EGOV_PROPERTY_HOST || "https://egov-micro-qa.egovernments.org",
