...
public class StoreEntity {
	...
	public Store toDomain() {
		...
		store.divisionName(divisionName);
	...
	public Object toEntity(Store store) {
		...
		/*
		 * this.createdBy = store.getAuditDetails().getCreatedBy(); this.createdTime =
		 * store.getAuditDetails().getCreatedTime(); this.lastmodifiedBy =
		 * store.getAuditDetails().getLastModifiedBy(); this.lastmodifiedTime =
		 * store.getAuditDetails().getLastModifiedTime();
		 */
		return this;
	}
