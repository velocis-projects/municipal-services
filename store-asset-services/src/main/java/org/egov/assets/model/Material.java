...
public class Material {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, material.id) && Objects.equals(this.tenantId, material.tenantId)
				&& Objects.equals(this.code, material.code) && Objects.equals(this.name, material.name)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, code, name, description, oldCode, materialType, baseUom, inventoryType,
				status, inActiveDate, purchaseUom, expenseAccount, minQuantity, maxQuantity, stockingUom, materialClass,
				reorderLevel, reorderQuantity, lotControl, shelfLifeControl, serialNumber, model, manufacturePartNo,
				techincalSpecs, termsOfDelivery, scrapable, assetCategory, storeMapping, auditDetails);
	}
