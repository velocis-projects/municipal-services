...
public class SupplierBill extends BillRegister {
	...
	/**
	 * Reason for cancellation of the Bill, Required only while cancelling Supplier
	 * Bill
	 *
	...
	/**
	 * Array of Material receipts used to create supplier bill. Only approved
	 * receipt will be used and there is no partial payment possible from each
	 * receipt.
	 *
	...
	public SupplierBill supplierBillAdvanceAdjustments(
			List<SupplierBillAdvanceAdjustment> supplierBillAdvanceAdjustments) {
		this.supplierBillAdvanceAdjustments = supplierBillAdvanceAdjustments;
		return this;
	}

	public SupplierBill addSupplierBillAdvanceAdjustmentsItem(
			SupplierBillAdvanceAdjustment supplierBillAdvanceAdjustmentsItem) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, supplierBill.id) && Objects.equals(this.tenantId, supplierBill.tenantId)
				...
				&& Objects.equals(this.deleted, supplierBill.deleted) && super.equals(o);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, store, invoiceNumber, invoiceDate, approvedDate, approvedBy,
				cancellationReason, cancellationRemarks, supplierBillReceipts, supplierBillAdvanceAdjustments, billId,
				supplierBillStatus, workFlowDetails, stateId, auditDetails, deleted, super.hashCode());
	}
	...
	public String toString() {
		...
		sb.append("    supplierBillAdvanceAdjustments: ").append(toIndentedString(supplierBillAdvanceAdjustments))
				.append("\n");
