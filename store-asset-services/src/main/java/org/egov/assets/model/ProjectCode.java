...
public class ProjectCode {
	...
	/**
	 * The active/inactive status of the project which refresents the boolean value
	 * True/False. By default the boolean value will be True.
	 * 
	 * @return active
	 **/
	...
	/**
	 * The cost of the Project. This value will be updated on Project closure which
	 * will include the complete expenditure on the project.
	 * 
	 * @return projectValue
	 **/
	@Valid
