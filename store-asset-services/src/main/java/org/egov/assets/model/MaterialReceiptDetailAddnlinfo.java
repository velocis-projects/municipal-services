...
/**
 * Hold the material receipt note material level additional information. This
 * will helpful to maintain/issue material in lot number,expiry date wise,
 * serial number wise and manufacture number wise. This object will be useful in
 * legacy data collection also.
 */
...
public class MaterialReceiptDetailAddnlinfo {
	...
	/**
	 * The date on which the materials are manufactured. Useful in case of opening
	 * balance screen
	 *
	 * @return receivedDate
	 **/
	...
	/**
	 * The date of expiry of the materials. This is required in case of materials
	 * that are of type shelf life control. Date must be greater than the receipt
	 * date.
	 *
	 * @return expiryDate
	 **/
	...
	/**
	 * The quantity of the material received for this particular purchase order or
	 * inter store transfer in the base UOM.
	 *
	 * @return quantity
	 **/
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, lotNo, serialNo, batchNo, manufactureDate, receiptDetailId, oldReceiptNumber,
				receivedDate, expiryDate, userQuantity, quantity);
	}
