...
public class PurchaseOrder {
	...
	public enum StatusEnum {
		CREATED("CREATED"), REVIEWOFSDO("REVIEWOFSDO"), REVIEWOFEE("REVIEWOFEE"), REVIEWOFSE("REVIEWOFSE"), REVIEWOFCE(
				"REVIEWOFCE"), SENDTOCREATOR("SENDTOCREATOR"), COMMISSIONERAPPROVAL("COMMISSIONERAPPROVAL"), APPROVED(
						"APPROVED"), REASSIGNTOJE("REASSIGNTOJE"), REVIEWOFCAO(
								"REVIEWOFCAO"), REVIEWOFACMC("REVIEWOFACMC"), REVIEWOFSO("REVIEWOFSO"), REVIEWOFSA(
										"REVIEWOFSA"), REVIEWOFSP("REVIEWOFSP"), REVIEWOFJC(
												"REVIEWOFJC"), REVIEWOFMOH("REVIEWOFMOH"), REJECTED("REJECTED"),
