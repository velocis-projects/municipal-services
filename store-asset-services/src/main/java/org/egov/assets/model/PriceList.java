...
/**
 * This object holds the pricelist information of different materials from
 * various suppliers
 */
@Builder
@AllArgsConstructor
...
public class PriceList {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, priceList.id) && Objects.equals(this.tenantId, priceList.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, supplier, rateType, rateContractNumber, rateContractDate, agreementNumber,
				agreementDate, agreementStartDate, agreementEndDate, active, fileStoreId, priceListDetails,
				auditDetails);
	}
