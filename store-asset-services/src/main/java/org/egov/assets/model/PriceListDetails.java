...
public class PriceListDetails {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, priceListDetails.id) && Objects.equals(this.tenantId, priceListDetails.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, material, fromDate, toDate, ratePerUnit, quantity, tenderUsedQuantity, uom,
				active, auditDetails);
	}
