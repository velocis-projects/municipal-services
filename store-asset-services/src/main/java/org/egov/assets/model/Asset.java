...
public class Asset {
	...
	/**
	 * Anticipated life of asset, This value is being calculated by diving 100 by
	 * the depreciation rate. for eg if the depreciation rate is 10%, then the
	 * anticiapted life will be 100/10 which equals 10years.
	 * 
	...
	/**
	 * This field contains year,month an day counts of the defect liability period
	 * in round figures.
	 * 
	 ...
	 * enabled is true, the voucher enabled flag can be accesed from the mdms(master
	 * data service).
	 * 
	 * @return assetAccount
	 **/
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Accumulated Depreciation\", this account field is mandatory only when the
	 * voucher enabled is true, the voucher enabled flag can be accesed from the
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Revaluation Reserve Account\", this account field is mandatory only when
	 * the voucher enabled is true, the voucher enabled flag can be accesed from the
	 * mdms(master data service).
	 * 
	...
	/**
	 * Options are from the chart of account master for the account code purpose
	 * \"Depreciation Expense Account\", this account field is mandatory only when
	 * the voucher enabled is true, the voucher enabled flag can be accesed from the
	 * mdms(master data service).
	 * 
	...
	/**
	 * names of the title documents available for the particular asset, values will
	 * be entered in comma separated format.
	 * 
	...
	/**
	 * Unique code for the asset. This will be auto generated. The format for the
	 * asset code will be given by the client in case of auto generation of asset
	 * code, The format of the code will be
	 * <ULB_NAME>/<Deprartmentcode>/<assetCategoryCode>/running sequence (for eg-
	 * mh.rohaRevenueBuilding12).
	 * 
	 * @return code
	 **/
	...
	/**
	 * Old Asset ID should be entered for Asset Older than go live Date of this
	 * module.
	 * 
	 * @return oldCode
	 **/
	...
	/**
	 * current written down value of the asset when being created or brought in to
	 * the system. This will be same as the original value for the newly created
	 * assets.
	 * 
	 * @return grossValue
	 **/
	 ...
	 * refer the Depreciation rate from yearWiseDepreciationRate object else refer
	 * to depreciationRate of asset.
	 * 
	...
	/**
	 * Asset level depreciation rate, if enableYearWiseDepreciation is false then
	 * check for depreciation rate from this field.
	 * 
	...
	/**
	 * Multiple rows can be specified for each asset category, but there should not
	 * be an overlap in the rates for the same financial year.It is required if
	 * enableYearWiseDepreciation is true, if enableYearWiseDepreciation if false
	 * then refer Depreciation from depreciationRate of asset.
	 * 
