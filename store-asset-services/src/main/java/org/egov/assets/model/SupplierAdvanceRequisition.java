...
/**
 * An Object gives information about advance issued againest purchase order.
 * There are multiple times advance requisition possible for selected purchase
 * order. But it should not cross alloted advance amount or advance percentage
 * defined in purchase order.
 */
...
public class SupplierAdvanceRequisition extends AdvanceRequisition {
	...
	/**
	 * Boolean value to identify whether the advance fully adjusted in supplier
	 * bill.
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, supplierAdvanceRequisition.id)
				...
				&& Objects.equals(this.advanceFullyAdjustedInBill,
						supplierAdvanceRequisition.advanceFullyAdjustedInBill)
				...
				&& Objects.equals(this.stateId, supplierAdvanceRequisition.stateId) && super.equals(o);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, supplier, purchaseOrder, auditDetails, advanceAdjustedAmount,
				advanceFullyAdjustedInBill, sarStatus, workFlowDetails, stateId, super.hashCode());
	}
