...
public class ScrapDetail {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, scrapDetail.id) && Objects.equals(this.tenantId, scrapDetail.tenantId)
				&& Objects.equals(this.scrapNumber, scrapDetail.scrapNumber)
				&& Objects.equals(this.material, scrapDetail.material) && Objects.equals(this.uom, scrapDetail.uom)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, scrapNumber, material, uom, receiptDetail, issueDetail, lotNumber, expiryDate,
				scrapReason, quantity, scrapQuantity, userQuantity, disposalQuantity, existingValue, scrapValue);
	}
