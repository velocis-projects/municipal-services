...
public class Uom {
	...
	public boolean equals(java.lang.Object o) {
		...
		Uom uom = (Uom) o;
		return Objects.equals(this.id, uom.id) && Objects.equals(this.tenantId, uom.tenantId)
				&& Objects.equals(this.name, uom.name) && Objects.equals(this.code, uom.code)
				&& Objects.equals(this.description, uom.description)
				&& Objects.equals(this.uomCategory, uom.uomCategory) && Objects.equals(this.baseUom, uom.baseUom)
				&& Objects.equals(this.fromDate, uom.fromDate) && Objects.equals(this.toDate, uom.toDate)
				&& Objects.equals(this.conversionFactor, uom.conversionFactor)
				&& Objects.equals(this.active, uom.active) && Objects.equals(this.auditDetails, uom.auditDetails);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, name, code, description, uomCategory, baseUom, fromDate, toDate,
				conversionFactor, active, auditDetails);
	}
