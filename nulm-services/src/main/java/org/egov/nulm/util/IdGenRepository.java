...
import org.egov.nulm.idgen.model.IdGenerationRequest;
import org.egov.nulm.idgen.model.IdGenerationResponse;
import org.egov.nulm.idgen.model.IdRequest;
...
public class IdGenRepository {
    ...
    @Autowired
    public IdGenRepository(RestTemplate restTemplate, NULMConfiguration config) {
     ...
     * @param tenantId The tenantiD of the NULM
