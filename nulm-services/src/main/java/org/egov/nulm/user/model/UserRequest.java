...
public class UserRequest extends User  {
        ...
        @Builder
        public UserRequest(Long id, String uuid, String userName, String password, String salutation, String name,
                         ...
                         String correspondenceAddress, Boolean active, String dob, String pwdExpiryDate,
                         ...
                         String identificationMark, String photo, String createdBy, String createdDate,
                         String lastModifiedBy, String lastModifiedDate, String otpReference, String tenantId,
                         Boolean isPrimaryOwner, Double ownerShipPercentage, String ownerType,
                         String institutionId,RelationshipEnum relationship,
                         Boolean userActive) {
        ...
        public UserRequest(org.egov.common.contract.request.User user){
                this.setTenantId(user.getTenantId());
                this.setUserName(user.getUserName());
                this.setId(user.getId());
                this.setName(user.getName());
         ...
         * @param user User object obtained from user service
         */
        public void addUserWithoutAuditDetail(UserRequest user){
                this.setUuid(user.getUuid());
                this.setId(user.getId());
                this.setUserName(user.getUserName());
                this.setPassword(user.getPassword());
