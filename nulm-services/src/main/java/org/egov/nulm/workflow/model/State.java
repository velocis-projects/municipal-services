package org.egov.nulm.workflow.model;
...
/**
 * A Object holds the basic data for a prscp services
 */
@ApiModel(description = "A Object holds the basic data for a prscp services")
@Validated
